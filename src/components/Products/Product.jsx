    ...
    <div>
      <div className="relative bg-slate-200 h-full p-4 rounded-md border border-slate-300">
        <div className="">
          ...
          <p className="text-center text-xl md:text-small font-semibold">
            {name}
          </p>
        ...
        <div className="w-full flex justify-center md:my-3 my-7">
          <button
            ...
            className="absolute bottom-1 bg-green-500 px-4 md:py-1 py-2 rounded-md  mx-auto text-white md:text-small text-xl"
          >
            Cart
          </button>
        </div>
