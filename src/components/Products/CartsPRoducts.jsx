...
const CartsPRoducts = ({ carts, clearCart ,children}) => {
  let total = 0;
  let quantity = 0;
  ...
  return (
    <div className="px-6 text-xl font-semibold text-slate-800 py-2 flex flex-col">
      <div className="py-1">
        ...
        <button
          onClick={clearCart}
          className="border-none text-white/80 bg-red-400 rounded-sm px-3 py-1 my-2"
        >
          Clear Cart
        </button>
        {children}
      ...
      {/* <div>
        <NavLink
          to="/order"
          className="border-none text-white/80 bg-green-400 rounded-sm px-3 py-1"
        >
          Review 
        </NavLink>
      </div> */}
